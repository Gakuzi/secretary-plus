document.addEventListener('DOMContentLoaded', () => {
    ...
    const adjustNavForChoice = () => {
        ...
        const googleSetupBackButton = document.querySelector('#google-cloud-setup .back-button');
        ...
        if (authChoice === 'direct') {
            ...
            if (googleSetupBackButton) {
                googleSetupBackButton.dataset.back = '1'; // Go back to choice screen
            }
            ...
            if (googleSetupBackButton) {
                googleSetupBackButton.dataset.back = '2'; // Go back to supabase screen
            }
        }
    };
